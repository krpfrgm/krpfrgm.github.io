        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative">
              <div className="aspect-square bg-gradient-to-br from-blue-100 to-blue-200 rounded-full flex items-center justify-center">
      ...
      <section id="about" className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-gray-900 mb-4">Про нас</h2>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            <Card className="text-center p-6">
              <CardContent className="space-y-4">
                ...
                <h3 className="font-semibold">9 років досвіду</h3>
            ...
            <Card className="text-center p-6">
              <CardContent className="space-y-4">
                ...
                <h3 className="font-semibold">502+ клієнтів</h3>
                <p className="text-gray-600 text-sm">
            ...
            <Card className="text-center p-6">
              <CardContent className="space-y-4">
                ...
                <h3 className="font-semibold">Професійно</h3>
                <p className="text-gray-600 text-sm">
            ...
            <Card className="text-center p-6">
              <CardContent className="space-y-4">
                ...
                <h3 className="font-semibold">Тернопіль</h3>
                <p className="text-gray-600 text-sm">
      ...
      <section id="highlights" className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Дізнайтеся більше про наші послуги та корисні п��ради
            </p>
          </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-7 gap-4">
            {highlights.map((highlight, index) => (
              <div key={index} className="text-center group cursor-pointer">
                <div className="w-16 h-16 bg-gradient-to-br from-blue-100 to-blue-200 rounded-full flex items-center justify-center mb-2 mx-auto group-hover:scale-110 transition-transform duration-300">
                ...
                <CardContent>
                  ...
                  <div className="flex items-center">
                    <div className="w-10 h-10 bg-blue-100 rounded-full flex items-center justify-center mr-3">
                      <span className="text-blue-600 font-medium">К</span>
                    </div>
                    <div>
                      <p className="font-medium text-gray-900">Клієнт</p>
              ...
              <div className="space-y-6">
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-blue-100">Тернопіль, Україна</p>
                  </div>
                </div>
